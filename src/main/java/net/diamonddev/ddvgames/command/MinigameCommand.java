...
public class MinigameCommand {
    ...
    public static int exeSet(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        context.getSource().sendFeedback(Text.translatable("ddv.command.feedback.set_game", game.getName().getString()), true);
        return 1;
    }

    public static int exeGet(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        context.getSource().sendFeedback(Text.translatable("ddv.command.feedback.get_game", DDVGamesMod.gameManager.getGame().getName().getString()), true);
        return 1;
    }
